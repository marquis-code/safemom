  ...
  <footer class="bg-gray-900" aria-labelledby="footer-heading">
    ...
    <div class="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-24 lg:px-8 lg:pt-32">
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        <div class="space-y-8">
          <img class="h-20" src="@/assets/img/logo2.png" alt="Company name">
          <p class="text-sm leading-6 text-gray-300">Healthy Moms, Happy Beginnings</p>
          <div class="flex space-x-6">
            <a href="https://www.instagram.com/safemom_" class="text-gray-500 hover:text-gray-400">
      ...
      <div class="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24">
        <p class="text-xs leading-5 text-gray-400">&copy; 2020 SafeMom, Inc. All rights reserved.</p>
      </div>
    </div>
  </footer>
