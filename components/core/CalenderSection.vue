<template>
    <div class="mx-auto  px-4 sm:px-6 lg:px-8">
        <h2 class="text-base font-semibold leading-6 text-gray-900">Upcoming appointments</h2>
        <div class="lg:grid lg:grid-cols-12 lg:gap-x-16">
            <div class="mt-10 text-center lg:col-start-8 lg:col-end-13 lg:row-start-1 lg:mt-9 xl:col-start-9">
                <div class="flex items-center text-gray-900">
                    ...
                    <div class="flex-auto text-sm font-semibold">June</div>
                    <button type="button"
                        class="-m-1.5 flex flex-none items-center justify-center p-1.5 text-gray-400 hover:text-gray-500">
              ...
              -->
                ...
                <button type="button"
                    class="mt-8 w-full rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Book Appointment</button>
            </div>
            <ol class="mt-4 divide-y divide-gray-100 text-sm leading-6 lg:col-span-7 xl:col-span-8">
                <li v-for="(itm, idx) in appointments" :key="idx" class="relative flex space-x-6 py-6 xl:static">
                    ...
                    <div class="flex-auto">
                        <h3 class="pr-10 font-semibold text-gray-900 xl:pr-0">{{ itm.name }}</h3>
                ...
                -->
                        <div class="absolute right-0 z-10 mt-2 w-36 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
